...
c.retrieve('reanalysis-era5-complete', {           # Requests follow MARS syntax
       ...
       'date'    : '2004-01-01/to/2006-12-31',     # The hyphens can be omitted
   ...
   }, 'Velocidades_2004-2006.nc')                            # Output file. Adapt as you wish.
...
dataset = xr.open_dataset("Velocidades_2004-2006.nc")
